...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("//Caso de prueba 1 recien se lanza (popularidad normal)");
        ...
        System.out.println("//Caso de prueba 2 supera 1.000 reproducciones");
        ...
        System.out.println("//Caso de prueba 3 baja del Auge por tener 5.000 dislikes o mas");
        ...
        System.out.println("//Caso de preuba 4 es tendencia por superar 50.000 reproducciones y 20.000 likes");
        ...
        System.out.println("//Caso de preuba 5 es tendencia pero baja a normal por no ser reproducida por 24 hs");
